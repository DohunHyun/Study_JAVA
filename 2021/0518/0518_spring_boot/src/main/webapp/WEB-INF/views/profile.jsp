...
<!-- 		<script type="text/javascript" src="./my_js/profile.js"></script> -->
		...
		function check() {
			if(document.getElementById("profileid").value == "") {
				alert("아이디 입력!!!");
				return;
			} else if(document.getElementById("profilepwd").value == "") {
				alert("비밀번호 입력!!!");
				return;
			} else {
				document.getElementById("checkform").action = "${root}/profile";
		...
		<!-- Wrapper -->
			<div id="wrapper">
                ...
                <section>
									...
									<form action="${root}/profile" id="checkform" method="post">
<!-- 									<input type="hidden" name="act" id="act" value="profilecheck"> -->
									<h4>ID: </h4><input type="text" name="profileid" id="profileid">
									<h4>PW: </h4><input type="password" name="profilepwd" id="profilepwd">
									<button type="button" value="check" class="m-2" onclick="javascript:check();">조회</button><br>
