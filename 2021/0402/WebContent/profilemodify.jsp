	...
	<head>
		...
		function modify() {
			if(document.getElementById("modifyid").value == "") {
				...
				alert("이름 입력!!!");
				return;
			} else if(document.getElementById("modifyphone").value == "") {
				alert("번호 입력!!!");
				return;
			} else if(document.getElementById("modifyaddress").value == "") {
				alert("주소 입력!!!");
				return;
			} else if(document.getElementById("modifypreferarea").value == "") {
				alert("선호지역 입력!!!");
				return;
			} else {
				document.getElementById("modifyform").action = "${root}/user";
		...
		<!-- Wrapper -->
			<div id="wrapper">
                ...
                <section>
									...
									<input type="hidden" name="act" id="act" value="profilemodify">
									<h4>ID: </h4><input type="text" name="modifyid" id="modifyid">
									<h4>PW: </h4><input type="password" name="modifypwd" id="modifypwd">
									<h4>NAME: </h4><input type="text" name="modifyname" id="modifyname">
									<h4>Phone: </h4><input type="tel" name="modifyphone" id="modifyphone">
									<h4>Address: </h4><input type="text" name="modifyaddress" id="modifyaddress">
