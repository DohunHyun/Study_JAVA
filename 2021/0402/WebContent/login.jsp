			...
			<div id="wrapper">
						...
						<div class="inner">
							...
							<!-- Header -->
								<header id="header">
									...
									<ul class="icons">
										<button type="button" id="joinin_btn" class="btn" onClick="location.href='./joinin.jsp'">
											Join in
										</button>
									</ul>
								</header>
                ...
                <section>
                  ...
                  <input type="hidden" name="act" id="act" value="login">
                    ID: <input type="text" class="form-control" name="userid" id="userid" class="mb-4">
                    PW: <input type="password" name="userpwd" id="userpwd">
                    <button type="button" value="Login" class="mt-4" onclick="javascript:login();">login</button>
					<input type="button" id="find_pwd" class="btn" value="비밀번호 찾기">
                  </form>
                </section>
						</div>
					</div>
