						...
						<div class="inner">
							...
							<!-- Header -->
								<header id="header">
									...
									<ul class="icons">
										<!-- <button type="button" id="login_btn" class="btn" data-toggle="modal" data-target="#login_modal">
											login
										</button>
										<button type="button" id="joinin_btn" class="btn" data-toggle="modal" data-target="#join_modal">
											Join in
										</button> -->
                    ...
                    <div class="modal-content"> -->
                      ...
                      <!-- <div class="modal-body">
													...
													<div class="form-group">
														...
														<input type="password" class="form-control" placeholder="Enter password" id="login_pwd">
													</div>
                      ...
                      <!-- <div class="modal-footer">
												<button type="submit" class="btn" id="submit_login">Login</button>
