...
public class StudentMain {
	...
	public void searchName() {
		System.out.println(">>>>>>>>  교육생  검색 (교육생이름으로 검색) ");
		System.out.println("검색하고자하는 교육생이름을 입력하세요.");
		String name = s.next();
		Student[] student = mgr.search(name);
		if(student.length == 0) System.out.println("검색하고자하는 이름의 교육생 정보가 없습니다.");
	...
	public void delete() {
		...
		System.out.println("삭제하고자하는 교육생 번호를 입력하세요.");
		int deleteNo = s.nextInt();
		boolean flag = mgr.delete(deleteNo);
		if (flag)
